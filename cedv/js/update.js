function update(y,m) {
    ...
    var td=((monthlyExports[y*12+m] + monthlyImports[y*12+m]));
    //console.log(td);
...
//console.log(td);
    ...
    eText.enter()
        ...
        .text(function(d) { return  (d.index+1)  + ". " + strFom(d.label); 
    })
...
function updateMonths(y,m) {
    ...
    monthEnter.append("text")
        .attr("transform",function (d,i) { return "translate (" + String(i*monthOffset-10) + ",38)"; })
...
function getExportColor(i) {
    ...
    if (e_colorByName[country]==undefined) {
        e_colorByName[country]=i_fill(i);
    }
...
function getImportColor(i) {
    ...
    if (i_colorByName[country]==undefined) {
        i_colorByName[country]=e_fill(i);
    }
