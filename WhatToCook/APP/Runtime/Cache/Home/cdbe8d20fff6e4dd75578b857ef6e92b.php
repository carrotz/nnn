...
<html lang="en">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">973项目和国家重大研究计划项目</li>
    </ul><!-- .breadcrumb -->
    ...
    <script type="text/javascript">
        ...
        jQuery(function($) {
            ...
            jQuery(grid_selector).jqGrid({
                ...
                url:"<?php echo U('Home/Part1/getlist_1_1');?>", /*需要修改*/
                datatype: "json",
                mtype:"POST",
                height: 400,
                
                colNames:['编号','医院名称','项目编号','项目名称','项目首席科学家/<br>课题负责人','项目第一承担单位','状态','校对信息'],/*需要修改*/
                colModel:[  {name:'id',index:'id',editable:false,align:'center',width:50},
                            {name:'hospname',index:'hospname',editable:false,align:'center'},
                            /*-start 需要修改开始-*/
                            {name:'projectno',index:'projectno',editable:true,align:'center'},
                            {name:'projectname',index:'projectname',editable:true,align:'center',width:250},
                            {name:'pi',index:'pi',editable:true,align:'center'},
                            {name:'firstorg',index:'firstorg',editable:true,align:'center'},
                            /*-end 需要修改结束-*/
                ...
                editurl: "<?php echo U('Home/Part1/edit_1_1');?>",/*需要修改*/
                autowidth: true
            });
            ...
            jQuery(grid_selector).jqGrid('navGrid',pager_selector,
                ...
                },
                {
                    ...
                    bSubmit: "保存",
                    bCancel: "取消",
                    url:"<?php echo U('Home/Part1/edit_1_1');?>",/*需要修改*/
                    mtype:"POST",
                    closeAfterEdit: true,
                    recreateForm: true,
